...
LEVELS = {
    1: {
        ...
        """ #f : "formatted string", pour inserer des variables directement dans le string
    },
    2: {
...
# Vérification API
if not api_key:
    st.info("👈 Entrez votre clé API Groq à gauche (ou configurez-la dans les secrets) pour commencer le jeu.")
    st.stop()
...
if st.session_state.level_complete:
    ...
    if prompt := st.chat_input("Votre message..."):
        ...
        try:
            ...
            st.error(f"Erreur API : {e}")
>>>>>>> 8c9ba34774c57cf80466c94b2d80f9f3c87d36c1
